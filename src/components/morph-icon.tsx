...
export function MorphIcon({ active, className }: { active: boolean; className?: string }) {
  ...
  return (
    <svg viewBox="0 0 512 512" className={className} aria-hidden>
      <defs>
        <linearGradient id="mi-grad" x1="0" x2="1" y1="0" y2="1">
          <stop offset="0%" stopColor="var(--rainbow-1)" />
          <stop offset="50%" stopColor="var(--rainbow-2)" />
          <stop offset="100%" stopColor="var(--rainbow-3)" />
        </linearGradient>
      </defs>
      <path
        ref={ref}
